	...
	if(rs.next()&&!rs1.next()){
		...
		if(rs.getString("valnumber").substring(0,1).equals("g")){
			...
			while(rs_val.next()){
				...
				ob.addProperty("isqualify",rs_val.getString("isqualify"));
				if(rs_val.getString("isqualify")!=null&&rs_val.getString("isqualify").equals("no")&&rs.getString("exlocationnum")!=null){
					ob.addProperty("storagelocationnum",rs.getString("exlocationnum"));
				}else{
